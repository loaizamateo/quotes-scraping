...
class QuotesSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'MEMUSAGE_NOTIFY_MAIL':['mateoloaiza1227@gmail.com'],
        'ROBOTSTXT_OBEY': True,
    ...
    def parse_only_quotes(self, response, **kwargs):
        ...
        all_quotes = response.xpath('//span[@class="text" and @itemprop="text"]/text()').getall()
        all_authors = response.xpath('//small[@class="author" and @itemprop="author"]/text()').getall()
        ...
        if next_page_button_link:
            #Follow detecta la URL absoluta
